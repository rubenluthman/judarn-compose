...
4. **Host-Symbiotic Invariant**: Judarn sets color, spatial rhythm, and typography. The host platform shapes geometry, depth, and touch mechanics. Never override host platform physics, hardware curves, or native interaction states.
